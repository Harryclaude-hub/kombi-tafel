...
// ESM-Ausgang fuer den Server-Waechter (ergebnis-scan). Diese Datei
// wird beim Deploy AUS auswertung.js erzeugt - nie von Hand aendern.
export { awZahl, awSeiten, awSeiteVonName, wetteLesen, wetteAuswerten, faktorFuer, kombiAuswerten, benoetigteFelder };
